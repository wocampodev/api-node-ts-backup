...
import SubscriptionORMRepository from '../app/subscription/infrastructure/persistence/typeorm/subscription.repository';
...
export default (): AwilixContainer => {
    ...
    container.register({
        ...
        subscriptionRepository: asClass(SubscriptionORMRepository).scoped(),
